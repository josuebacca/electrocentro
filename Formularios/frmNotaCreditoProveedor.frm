...
Private Sub CmdBuscAprox_Click()
    ...
    If FechaDesde <> "" Then sql = sql & " AND NC.CPR_FECHA>=" & XDQ(FechaDesde)
    If FechaHasta <> "" Then sql = sql & " AND NC.CPR_FECHA<=" & XDQ(FechaHasta)
    If chkTipoFactura.Value = Checked Then sql = sql & " AND NC.TCO_CODIGO=" & XN(cboNotaCredito1.ItemData(cboNotaCredito1.ListIndex))
    sql = sql & " ORDER BY NC.CPR_NUMERO"
...
Private Sub cmdGrabar_Click()
    ...
    If rec.EOF = True Then
        ...
        sql = sql & " CPR_OBSERVACION,CPR_NROSUCTXT,CPR_NUMEROTXT,CPR_SUBTOTAL,CPR_TOTAL,CPR_SALDO,CPR_BONIPESOS, EST_CODIGO)"
        sql = sql & " VALUES ("
        ...
        For I = 1 To grdGrilla.Rows - 1
            If grdGrilla.TextMatrix(I, 0) <> "" Then
                ...
                sql = sql & " (TCO_CODIGO,CPR_NUMERO,CPR_SUCURSAL,"
            ...
            Case 0, 1 'PRODUCTO Y DESCRIPCION
                ...
                If lblEstadoNotaCredito.Caption = "PENDIENTE" Then
                    ...
                    If grdGrilla.Col = 0 Then
                        sql = sql & " P.PTO_CODIGO LIKE '" & XN(txtEdit) & "'"
                    Else
