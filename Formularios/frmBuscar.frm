...
Public Sub ArmaSQL()
    ...
    Case 2 'PRODUCTOS precio Venta
        If CodListaPrecio = 0 Then
            sql = "SELECT TOP 300 P.PTO_CODIGO,P.PTO_DESCRI, P.PTO_PRECIO, R.RUB_DESCRI, L.LNA_DESCRI, RE.TPRE_DESCRI"
        ...
        Else
            ...
            sql = sql & " FROM PRODUCTO P, RUBROS R, LINEAS L, TIPO_PRESENTACION RE"
            sql = sql & " WHERE"
            sql = sql & " P.LIS_CODIGO=" & CodListaPrecio
    ...
    Case 7 'PRODUCTOS precio compra
     ...
     Case 8 ' cheques entregados
      ...
      Case 9 'cheques propios
        ...
        End If
      Case 10
        sql = "SELECT * FROM BANCO WHERE BAN_DESCRI LIKE '%" & Trim(TxtDescriB) & "%'"
    ...
    Case 7 'PRODUCTOS PRECIO COMPRA
     ...
     Case 8 'cheque entregado
      ...
      Case 9 'cheque PROPIO entregado
       ...
       Case 10
        Do While Not Registro.EOF
            grdBuscar.AddItem Trim(Registro!BAN_CODINT) & Chr(9) & _
                              Trim(Registro!BAN_DESCRI)
            Registro.MoveNext
            grdBuscar.Refresh
        Loop
...
Private Sub Form_Activate()
    ...
    Case 8 'CHEQUES entregados
     ...
     Case 9 'CHEQUES PROPIOS ENTREGADOS
        ...
        cmdBuscaAprox_Click
      Case 10
        Me.Caption = "Buscar:[Bancos]"
        grdBuscar.Width = 7000
        grdBuscar.Cols = 2
        grdBuscar.FormatString = "Codigo|Nombre Banco"
        grdBuscar.ColWidth(0) = 1500 'Banco
        grdBuscar.ColWidth(1) = 5000 'Cheuqe Nro
        cmdBuscaAprox_Click
    End Select
