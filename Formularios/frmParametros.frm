...
Private Sub CmdGrabar_Click()
    ...
    End If
    sql = sql & " ,PORGAN=" & XN(txtPorGan.Text)
...
Private Sub BuscarDatos()
    ...
    If rec.EOF = False Then
        ...
        End If
        txtPorGan.Text = IIf(IsNull(rec!PORGAN), 0, rec!PORGAN)
    End If
    rec.Close
End Sub
...
Private Sub txtPorGan_GotFocus()
    SelecTexto txtPorGan
End Sub

Private Sub txtPorGan_KeyPress(KeyAscii As Integer)
    KeyAscii = CarNumeroDecimal(txtPorGan, KeyAscii)
End Sub
