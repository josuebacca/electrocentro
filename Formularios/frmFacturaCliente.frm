   ...
   Begin TabDlg.SSTab tabDatos 
      ...
      Begin VB.Frame FrameFactura 
         ...
         Begin VB.TextBox txtNroFactura 
            ...
            Width           =   1065
         End
         Begin VB.PictureBox FechaFactura 
            Height          =   285
            Left            =   2950
            ScaleHeight     =   225
            ScaleWidth      =   1095
...
Private Function ValidarFactura() As Boolean
    ...
    If cboCondicion.ItemData(cboCondicion.ListIndex) = 1 Then ' FORMA PAGO DE CONTADO
        If CDbl(txtTotal.Text) >= 1000 Then
            MsgBox "La Condición de Venta no es Correcta", vbExclamation, TIT_MSGBOX
            cboCondicion.SetFocus
            ValidarFactura = False
            Exit Function
        End If
...
Private Sub Form_Load()
    ...
    GrdModulos.FormatString = "Tipo Fac|^Número|^Fecha|Cliente|Domicilio|Vendedor|Cod_Estado|" _
