...
Private Sub cmdListar_Click()
    ...
    If FechaDesde.Text <> "" Then
        If Rep.SelectionFormula = "" Then
            Rep.SelectionFormula = " {CTA_CTE_PROVEEDORES.CTA_CTE_FECHA}>= DATE (" & Mid(FechaDesde.Text, 7, 4) & "," & Mid(FechaDesde.Text, 4, 2) & "," & Mid(FechaDesde.Text, 1, 2) & ")"
        Else
            Rep.SelectionFormula = Rep.SelectionFormula & " AND {CTA_CTE_PROVEEDORES.CTA_CTE_FECHA}>= DATE (" & Mid(FechaDesde.Text, 7, 4) & "," & Mid(FechaDesde.Text, 4, 2) & "," & Mid(FechaDesde.Text, 1, 2) & ")"
        End If
    End If
    If FechaHasta.Text <> "" Then
        If Rep.SelectionFormula = "" Then
            Rep.SelectionFormula = " {CTA_CTE_PROVEEDORES.CTA_CTE_FECHA}<= DATE (" & Mid(FechaHasta.Text, 7, 4) & "," & Mid(FechaHasta.Text, 4, 2) & "," & Mid(FechaHasta.Text, 1, 2) & ")"
        Else
            Rep.SelectionFormula = Rep.SelectionFormula & " AND {CTA_CTE_PROVEEDORES.CTA_CTE_FECHA}<= DATE (" & Mid(FechaHasta.Text, 7, 4) & "," & Mid(FechaHasta.Text, 4, 2) & "," & Mid(FechaHasta.Text, 1, 2) & ")"
        End If
    End If
    If FechaDesde.Text <> "" And FechaHasta.Text <> "" Then
