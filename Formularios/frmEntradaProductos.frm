   ...
   Begin TabDlg.SSTab tabDatos 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.ComboBox cboEmpleado 
            ...
            Width           =   3120
         End
         Begin FechaCtl.Fecha fecRemito 
            Height          =   360
            Left            =   5685
            TabIndex        =   6
            Top             =   990
...
Private Sub CmdBuscAprox_Click()
    ...
    If chkFecha.Value = Checked Then
        If FechaDesde <> "" Then sql = sql & " AND E.EPR_FECHA>=" & XDQ(FechaDesde)
        If FechaHasta <> "" Then sql = sql & " AND E.EPR_FECHA<=" & XDQ(FechaHasta)
    End If
    ...
    If txtNumero.Text <> "" Then
        ...
        If Rec1.EOF = False Then
            ...
            If Not IsNull(Rec1!REP_CODIGO) Then
               ...
               fecRemito.Text = Rec1!EPR_FECHAREM
