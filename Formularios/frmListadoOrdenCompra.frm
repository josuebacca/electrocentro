...
Private Sub cmdListar_Click()
    ...
    If optGeneralTodos.Value = True Then
        ...
        If FechaDesde.Text <> "" Then
            If Rep.SelectionFormula = "" Then
                Rep.SelectionFormula = " {ORDEN_COMPRA.OC_FECHA}>= DATE (" & Mid(FechaDesde.Text, 7, 4) & "," & Mid(FechaDesde.Text, 4, 2) & "," & Mid(FechaDesde.Text, 1, 2) & ")"
            Else
                Rep.SelectionFormula = Rep.SelectionFormula & " AND {ORDEN_COMPRA.OC_FECHA}>= DATE (" & Mid(FechaDesde.Text, 7, 4) & "," & Mid(FechaDesde.Text, 4, 2) & "," & Mid(FechaDesde.Text, 1, 2) & ")"
            End If
        End If
        
        If FechaHasta.Text <> "" Then
            If Rep.SelectionFormula = "" Then
                Rep.SelectionFormula = " {ORDEN_COMPRA.OC_FECHA}<= DATE (" & Mid(FechaHasta.Text, 7, 4) & "," & Mid(FechaHasta.Text, 4, 2) & "," & Mid(FechaHasta.Text, 1, 2) & ")"
            Else
                Rep.SelectionFormula = Rep.SelectionFormula & " AND {ORDEN_COMPRA.OC_FECHA}<= DATE (" & Mid(FechaHasta.Text, 7, 4) & "," & Mid(FechaHasta.Text, 4, 2) & "," & Mid(FechaHasta.Text, 1, 2) & ")"
            End If
        End If
    ...
    If optDetallado.Value = True Then
        ...
        End If
        Rep.SelectionFormula = ""
        Rep.SelectionFormula = "{ORDEN_COMPRA.OC_NUMERO}=" & XN(GrdModulos.TextMatrix(GrdModulos.RowSel, 0)) _
