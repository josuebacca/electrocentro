...
Begin VB.Form frmNotaCreditoCliente 
   ...
   Begin TabDlg.SSTab tabDatos 
      ...
      Begin TabDlg.SSTab tabLista 
         ...
         TabPicture(0)   =   "frmNotaCreditoCliente.frx":4184
         Tab(0).ControlEnabled=   -1  'True
         Tab(0).Control(0)=   "Frame2"
         Tab(0).Control(0).Enabled=   0   'False
         Tab(0).ControlCount=   1
         TabCaption(1)   =   "Repuestos"
         TabPicture(1)   =   "frmNotaCreditoCliente.frx":41A0
         Tab(1).ControlEnabled=   0   'False
...
Public Sub ImprimirNotaCredito()
    ...
    For w = 1 To 2 'SE IMPRIME POR DUPLICADO
      ...
      '---- IMPRESION DE LA NOTA CREDITO ------------------
        ...
        For I = 1 To grdGrilla.Rows - 1
            If grdGrilla.TextMatrix(I, 0) <> "" Then
                Imprimir 1, Renglon, False, Format(grdGrilla.TextMatrix(I, 0), "000000")  'codigo
                ...
                Imprimir 14.2, Renglon, False, grdGrilla.TextMatrix(I, 3) 'precio
                Imprimir 14.8, Renglon, False, grdGrilla.TextMatrix(I, 4) 'bonoficacion
...
'            Imprimir 17, 16.8, True, txtSubtotal.Text
...
Public Sub ImprimirEncabezado()
 '-----------IMPRIME EL ENCABEZADO DE LA NOTA DE CREDITO-------------------
    ...
    Imprimir 11.7, 2.1, False, "=============   NOTA DE CRÉDITO"
    'año = String(4, Year(FechaNotaCredito))
    año = Year(FechaNotaCredito)
    Imprimir 15.9, 4.4, False, Format(Day(FechaNotaCredito), "00")
    Imprimir 16.95, 4.4, False, Format(Month(FechaNotaCredito), "00")
    Imprimir 18, 4.4, False, Mid(año, 3, 2)
    ...
    If Rec1.EOF = False Then
        ...
        'FACTURA
        'Imprimir 13.8, 7.2, True, Format(txtNroFactura.Text, "00000000") & " del " & Format(FechaFactura.Value, "dd/mm/yyyy")
...
Private Sub Form_Load()
    ...
    GrdModulos.FormatString = "^Tipo|^Número|^Fecha|Cliente|Domicilio|Cod_Estado|" _
