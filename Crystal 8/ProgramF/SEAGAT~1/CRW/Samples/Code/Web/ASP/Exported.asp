...
<HR>
      <H2><font face="Arial, Helvetica, sans-serif">El explorador no puede ver el tipo 
        de archivo exportado en forma nativa. </font></H2>
<BR>
      <a href="<%=session("ExportVirtualDirectory") & session("filename")%>"><font face="Arial, Helvetica, sans-serif">Haga 
      clic aquí para descargar archivo</font></a> 
      <HR>
<BR>
<form>
